...
ButtonAnswer getButtonInput () {
  if (digitalRead(BUTTON_START)) { return ButtonAnswer::action; }
  if (digitalRead(BUTTON_ONE)) { return ButtonAnswer::one; }
  if (digitalRead(BUTTON_TWO)) { return ButtonAnswer::one; }
  if (digitalRead(BUTTON_THREE)) { return ButtonAnswer::one; }
  if (digitalRead(BUTTON_FOUR)) { return ButtonAnswer::one; }
  if (digitalRead(BUTTON_FIVE)) { return ButtonAnswer::one; }
